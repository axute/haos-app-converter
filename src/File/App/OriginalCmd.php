...
use App\File\Traits\AppFileTrait;
...
class OriginalCmd extends FileAbstract
{
    ...
    {
        $this->original_cmd = $this->isFile() ? $this->loadFile() : '';
        return $this;
    }
    ...
    {
        $this->original_cmd = $webform->isQuirks() ? Crane::i($webform->extractFullDockerImageName())->getCmd('') : null;
