...
- **Ingress Support**: Configure Home Assistant Ingress for seamless web interface access.
- **Backup Integration**: Mark your add-ons as backup-compatible.
...
- **Global Settings**: Configure your repository name and maintainer globally.
